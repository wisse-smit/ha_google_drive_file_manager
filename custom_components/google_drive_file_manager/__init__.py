...
from .helpers.google_drive_actions import async_get_list_video_mp4_files
...
async def async_setup_entry(hass: HomeAssistant, entry) -> bool:
    ...
    # 1. Re‑instantiate and register our OAuth2 implementation so HA can find it on restart
    ...
    # 2. Create the OAuth2Session (handles token refresh & storage)
